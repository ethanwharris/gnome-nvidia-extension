...
const SETTINGS = {
    ...
    provider: {
        ...
        options: ['Nvidia Settings and SMI', 'Nvidia Settings', 'Nvidia SMI', 'Optimus with Bumblebee', 'Nvidia Settings and SMI (Laptops)', 'Nvidia Settings (Laptops)', 'Nvidia SMI (Laptops)'],
    },
    spacing: {
        type: 'int',
        key: 'spacing',
