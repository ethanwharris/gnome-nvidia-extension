...
/* exported SettingsAndSmiProvider SettingsAndSmiLaptopProvider */
'use strict';
...
var SettingsAndSmiLaptopProvider = class {
    constructor() {
        this.settings = new SettingsProvider.SettingsLaptopProvider();
        this.smi = new SmiProvider.SmiLaptopProvider();
    }
